...
PS C:\Users\vijay\.gemini\antigravity\scratch\semantic_organizer> git status --porcelain
>> git add -A
>> git status --porcelain
>> git commit -m "chore: update README and demo assets" || echo "no changes to commit"
>> git push origin main
At line:4 char:54
+ git commit -m "chore: update README and demo assets" || echo "no chan ...
+                                                      ~~
